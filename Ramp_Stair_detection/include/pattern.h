...
class Pattern
{
	public:
		...
		int id;
		int orientation;//{0,1,2,3}// orientation 0 horizental 1 90 daraje chrkhesh dar jahat aghrabe haya saat 2 180 daraje charkhesh 
        ...
        void draw(Mat& frame, const Mat& camMatrix, const Mat& distMatrix,Point points[4]);
		...
		//calculagte vertex points of pattern
		void setPoints(const Mat& camMatrix, const Mat& distMatrix,Point vertexpoints[4]);
};
